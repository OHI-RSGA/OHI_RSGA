...
### Species
The habitat component of the biodiversity goal measures the conservation status of marine species.
...
We will first look at the data underlying the species condition subgoal and then then habitat subgoal. 
...
For more details see the data preparation [script](https://ohi-science.org/ohiprep_v2023/globalprep/spp/v2022/spp_data_prep.html).
...
Saudi Arabia's score of 62 is the lowest within the region. This is primarily due to poor condition of mangrove forests and soft-bottom habitat.
