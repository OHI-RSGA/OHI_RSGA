...
All counties in the region have very low mariculture scores, this is primarily because the region has far more mariculture potential than what is currently realized. This is not an unusual result, based on the global assessment, given that mariculture expansion is just taking off.
...
For more details see the data preparation [script](https://ohi-science.org/ohiprep_v2023/globalprep/mapr/v2022/spp_data_prep.html).
